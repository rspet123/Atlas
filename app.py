...
def post_signup(id,name):
    ...
    try:
        request.form["tank"]
        roles.append(("https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/Tank_icon.svg/228px-Tank_icon.svg.png?20190921150350","TANK"))
    except Exception:
        #This is rly bad code lol
        pass
    try:
        request.form["dps"]
        roles.append(("https://upload.wikimedia.org/wikipedia/commons/thumb/a/af/Damage_icon.svg/1200px-Damage_icon.svg.png","DPS"))
    except Exception:
        # This is rly bad code lol
        pass
    try:
        request.form["support"]
        roles.append(("https://upload.wikimedia.org/wikipedia/commons/thumb/f/ff/Support_icon.svg/1200px-Support_icon.svg.png","SUPPORT"))
    except Exception:
        # This is rly bad code lol
        pass
    print(roles)
